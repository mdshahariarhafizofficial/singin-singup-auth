...
const Login = () => {
  return (
    <div className="bg-linear-65 from-purple-500 pt-20 to-pink-500 h-screen">
      ...
      <form className="max-w-sm mx-auto bg-white p-5 space-y-4 rounded-xl">
        <div>
            <h2 className="text-center text-3xl font-bold">Login Now</h2>
            <div className="my-5 flex gap-0">
                <NavLink to="/login" type="button" className={
                    ({isActive})=> isActive? "w-full text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-sm text-sm px-5 py-2.5 text-center mb-2": "w-full text-black border-2 border-gray-200 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-sm text-sm px-5 py-2.5 text-center mb-2"
                }>Login</NavLink>
                <NavLink to="/register" type="button" className={
                    ({isActive})=> isActive? "w-full text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-sm text-sm px-5 py-2.5 text-center mb-2": 
